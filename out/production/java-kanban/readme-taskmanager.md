...
2)  Переработал добавление эпиков и подзадач - теперь эпик создается отдельно, подзадачи при добавлении меняют время начала , конца, продолжительность и статус эпика. 
