...
4) Убрал промежуточные задачи пустышки - из-за того что вынес условие по проверки наличия в main

5) Добавил метод только для InMemoryTaskManager - проверку статуса эпика - применяю при любых манипуляциях с подзадачами.
